...
@Component({
  selector: 'app-student-requests-by-school',
  templateUrl: './student-requests-by-school.component.html',
  styleUrls: ['./student-requests-by-school.component.scss']
})
export class StudentRequestsBySchoolComponent {
  ...
  getGraphDate(date: DateRange) {
    ...
    this.reportService.getApprovedBySchool(params).subscribe({
      next: (res) => {
